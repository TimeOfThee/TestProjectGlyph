...
public class RuneDisplay {
	...
	public RuneDisplay(Handler ha,float x, float y,float size,Color fontClor) {
		this.ha=ha;
		this.km=ha.getKM();
		this.angle=0;
	...
	}public RuneDisplay(Handler ha,float x, float y,float size,Letter[] letters) {
		this.ha=ha;
		this.angle=0;
		this.loc=new float[] {x,y};
		this.size=size;
	...
	public void update() {
		...
		letters[select].setColor(fontClor.brighter());
	}
	public void render(Graphics g) {
		...
		g.setColor(new Color(fontClor.brighter().getRed(),fontClor.brighter().getGreen(),fontClor.brighter().getBlue(),60));
